...
argParser.add_argument(
		"--full", help="write entire calendar to HTML", action="store_true"
)
...
try:
		...
		f_cfg.write("mdInPath = 'src/calendar.md'\n")
		f_cfg.write("mdOutPath = 'src/calendar_cleaned.md'\n")
		f_cfg.write("calendarOutPath = 'book/calendar.html'\n")
		f_cfg.write("cssPath = '/wbin-extras/MDcalendar/mdStyle.css'")
		f_cfg.close()
		import mdCalendarConfig as cfg
...
while dt <= eDt:
		f.write(
				c.formatMonthMd(dt.year, dt.month, calDictHtml, rrDictHtml, calCustomIdDict)
		)
